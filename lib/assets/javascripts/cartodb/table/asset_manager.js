  ...
  cdb.admin.SelectAssetPane = cdb.admin.ImportPane.extend({
    ...
    _selectLastAsset: function() {
      ...
      console.log("change model attribute -> value!");
    ...
    _onAssetChange: function() {
      ...
      console.log(selected_asset && selected_asset.get('public_url'));
    },
  ...
  cdb.admin.AssetManager = cdb.admin.BaseDialog.extend({
    ...
    _renderAssetsPane: function() {
      ...
      this.assetsPane.bind('valueChange', this._checkOKButton, this);
